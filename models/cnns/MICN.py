...
class Model(nn.Module):
    ...
    def __init__(self, configs, conv_kernel=[12, 16]):
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast' or self.task_name == 'forecast':
            # refer to DLinear
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        x_mark_dec = torch.cat([x_mark_enc, x_mark_dec[:, -self.pred_len:, :]], dim=1) ################# revised to handle different seq_len and label_len
