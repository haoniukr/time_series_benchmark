...
class ExtractData:
    ...
    def one_loop(self, loader):
        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_y_mask) in enumerate(loader):
    ...
    def extract_data(self):
        ...
        print("scaler:", train_data.scaler.mean_, train_data.scaler.var_)
        if not os.path.exists(self.args.save_path):
            os.makedirs(self.args.save_path)
        pickle.dump([train_data.scaler.mean_, train_data.scaler.var_], open(self.args.save_path+'/scaler.pkl', 'wb'))
...
if __name__ == '__main__':
    ...
    if 'electricity' in args.data_path and args.data == 'custom' and args.enc_in == 321:
        ...
        pass    
    elif 'NYTM-0919' in args.data_path and args.data == 'custom' and args.enc_in == 67:
        pass
    elif '2m-temperature-NA' in args.data_path and args.data == 'custom' and args.enc_in == 126:
        pass
    elif 'metr-la' in args.data_path and args.data == 'custom' and args.enc_in == 207:
        pass
    elif 'pems-bay' in args.data_path and args.data == 'custom' and args.enc_in == 325:
        pass
