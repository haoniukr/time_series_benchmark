...
data_path_name=../../datasets/electricity.csv
data_name=custom
random_seed=2021
pred_len=96
gpu=0
...
python -u forecasting/extract_forecasting_data.py \
  ...
  --trained_vqvae_model_path 'forecasting/saved_models/electricity/CD64_CW256_CF4_BS4096_ITR15000/checkpoints/final_model.pth'\
