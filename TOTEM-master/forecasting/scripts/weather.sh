seq_len=96
root_path_name=/mnt/kgc/nas/git_repo/time_series_benchmark/TOTEM-master/
data_path_name=../../datasets/weather.csv
data_name=custom
random_seed=2021
pred_len=96
gpu=0
...
python -u forecasting/extract_forecasting_data.py \
  ...
  --trained_vqvae_model_path "forecasting/saved_models/weather/CD64_CW256_CF4_BS4096_ITR15000/checkpoints/final_model.pth"\
