...
class ExtractData:
    ...
    def one_loop_forecasting(self, loader, vqvae_model):
        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_y_mask) in enumerate(loader):
            ...
            y_original_mask.append(batch_y_mask)
        ...
        y_original_mask_arr = np.concatenate(y_original_mask, axis=0)
        ...
        data_dict['y_original_mask_arr'] = y_original_mask_arr
        ...
        print(data_dict['y_original_mask_arr'].shape)
...
def save_files_forecasting(path, data_dict, mode, save_codebook):
    ...
    np.save(path + mode + '_y_original_mask.npy', data_dict['y_original_mask_arr'])
