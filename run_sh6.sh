...
python -u run.py \
  ...
  --itr 1 >logs/Forecasting/NYTM-0919_$model_id'_'1'_'$random_seed'_'$seq_len'_'$pred_len'_'${year_start}.log  
...
python -u run.py \
  ...
  --itr 1 >logs/Forecasting/2m-temperature-NA_$model_id'_'1'_'$random_seed'_'$seq_len'_'$pred_len'_'${year_start}.log  
