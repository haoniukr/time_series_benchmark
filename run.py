...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Multivariate Time Series Forecasting Benchmark')
...
#                         help='1: channel dependence 0: channel independence for FreTS model')
    ...
    parser.add_argument('--individual', action='store_true', default=False, help='a model for each variate(channel) individually')
    parser.add_argument('--num_networks', type=int, default=1, help='number of networks')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_nn{}_rs{}_{}_{}'.format(
                args.data_path[:-4],
                args.task_name,
                args.model_id,
                args.model,
                ...
                args.embed,
                args.distil,
                args.num_networks, args.random_seed,
                args.des, ii)
