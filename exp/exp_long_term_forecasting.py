...
#                     visual(gt, pd, os.path.join(folder_path, str(i) + '.pdf'))
        ...
        self.df = pd.DataFrame([[self.args.data_path[:-4],self.args.model_id, self.args.num_networks, self.args.random_seed, self.args.seq_len, self.args.pred_len] + self.metric_save + [self.train_epochs+1, "-", "-", "-"] + [self.args]], columns=result_columns)
